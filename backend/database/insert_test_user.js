// ============================================================
// SCRIPT : Insertion d'un utilisateur test
// Usage : node database/insert_test_user.js
// ============================================================
...
async function insertTestUser() {
  console.log('🚀 Insertion d\'un utilisateur test...\n');

  try {
    // Lire le fichier SQL
    const sqlPath = path.join(__dirname, 'insert_test_user.sql');
